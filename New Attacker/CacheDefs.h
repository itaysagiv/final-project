...
#define LINES_POOL 1200
#define SETS_LINES_POOL 100
//#define LINES_FOR_EVICTION_ALGORITHEM  (LINES_IN_CACHE * 5)
#define LINES_FOR_EVICTION_ALGORITHEM  (LINES_IN_CACHE * 40)
#define SLICE_NUM 4
#define SETS_IN_SLICE (SETS_IN_CACHE / SLICE_NUM)
#define RAW_SETS (SETS_IN_CACHE / SLICE_NUM)
#define RAW_LINES_IN_SET (LINES_IN_SET * SLICE_NUM *2)
...
#define CACHE_POLL_MAX_HIT_THRESHOLD_IN_TICKS 125
...
#define CACHE_POLL_TIME_PER_SET    2000000
...
typedef struct Lines_Pool {
	char* Lines[LINES_POOL];
	Cache_Set Sets[SETS_LINES_POOL];
	int ValidLines;
	int ValidSets;
}Lines_Pool;
