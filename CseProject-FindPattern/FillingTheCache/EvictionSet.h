 ...
 */
__always_inline char* ExtractKeyFromSet(Cache_Set* pSet, char OnesPattern[], char ZerosPattern[], int PatternBitsNum, int KeysToSample, char RsaKey[KEYS_LEN_IN_BITS / 8],int* samples_found);

/**
	This function extract the key from given samples
*/
